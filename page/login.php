		...
		<div class="row">
			...
			<div class="col-sm-3">
				...
				<form method="POST">
					...
					<div>
					<input class="btn btn-success btn-lg btn-block" type="submit" value="Logi sisse">
					</div>
			...
			<div class="col-sm-3 col-sm-offset-3">
				...
				<form method="POST">
					...
					<input class="btn btn-Success btn-lg hidden-xs" type="submit" value="Loo kasutaja">
					<input class="btn btn-Success btn-lg btn-block visible-xs-block" type="submit" value="Loo kasutaja">
