<?php 
	...
	if ( isset($_POST["birthday"]) && 
		...
		$Finish->save($Helper->cleanInput($_POST["birthday"]), $Helper->cleanInput($_POST["country"]));
...
<?php 
	...
	$html .= "<tr>";
		...
		$html .= "<th>
					<a href='?q=".$q."&sort=birthday&order=".$birthdayOrder."'>
						birthday
					</a>
				 </th>";
		$html .= "<th>
					<a href='?q=".$q."&sort=country'>
						country
					</a>
				 </th>";
	$html .= "</tr>";
	...
	foreach($finishData as $f){
		...
		$html .= "<tr>";
			$html .= "<td>".$f->id."</td>";
			$html .= "<td>".$f->birthday."</td>";
			$html .= "<td>".$f->country."</td>";
